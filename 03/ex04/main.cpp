...
{
	{
		...
		{
			NinjaTrap r4nd_tp("RandTrappyA");
			n1nj4_tp.ninjaShoebox(r4nd_tp);
		}{
			ScavTrap r4nd_tp("RandTrappyB");
			n1nj4_tp.ninjaShoebox(r4nd_tp);
		}{
			FragTrap r4nd_tp("RandTrappyC");
			n1nj4_tp.ninjaShoebox(r4nd_tp);
		}
		std::cout << std::endl << ":: Now, failing tests :: " << std::endl << std::endl;
		std::cout << "After repair, hit_points and energy_points cannot exceed their maximum:" << std::endl;
		...
		std::cout << std::endl << "SUPERTRAP SECTION" << std::endl;
		SuperTrap sup3r_tp("Supertrappy");
		std::string victim("anti-sup3r-tp");
		{
			std::cout << std::endl << ":: Canonical demo ::" << std::endl << std::endl;
			std::cout << sup3r_tp << std::endl;
			SuperTrap copy_sup3r_tp = sup3r_tp;
			std::cout << copy_sup3r_tp << std::endl;
		}
		std::cout << std::endl << ":: test features ::" << std::endl << std::endl;
		sup3r_tp.rangedAttack(victim);
		std::cout << sup3r_tp << std::endl;
		sup3r_tp.meleeAttack(victim);
		std::cout << sup3r_tp << std::endl;
		sup3r_tp.takeDamage(42);
		std::cout << sup3r_tp << std::endl;
		sup3r_tp.beRepaired(21);
		std::cout << sup3r_tp << std::endl;
		sup3r_tp.vaulhunter_dot_exe(victim);
		{
			NinjaTrap r4nd_tp("RandTrappyA");
			sup3r_tp.ninjaShoebox(r4nd_tp);
		}{
			ScavTrap r4nd_tp("RandTrappyB");
			sup3r_tp.ninjaShoebox(r4nd_tp);
		}{
