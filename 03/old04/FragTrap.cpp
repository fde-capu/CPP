...
const int			FragTrap::_u_default[8] = {1,
	FR4G_TP_HIT_POINTS,
	FR4G_TP_MAX_HIT_POINTS,100,100,30,FR4G_TP_RANGED_ATTACK_DAMAGE,
...
{
	std::cout << "[sys]\tLocal call of FragTrap::rangedAttack." << std::endl;
