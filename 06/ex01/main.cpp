...
/*   Updated: 2021/07/17 17:55:51 by fde-capu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "### Data * deserialize_new(uintptr_t raw);" << std::endl << std::endl;
	{
		...
		std::cout << "Send the return value in deserialize (new)." << std::endl;
		std::cout << "Data * re_data = deserialize_new(" << address << ");" << std::endl << std::endl;
